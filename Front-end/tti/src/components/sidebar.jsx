...
import {
  ...
  CreditCard, BarChart2, Calendar, Wallet, FileText, Receipt, TrendingUp,
  CheckCircle, Building2, AlertTriangle, Paperclip, FileStack, Bookmark,
  Scale, Bell, LogOut, ChevronRight, Menu, User, KeyRound, X
} from "lucide-react";
      ...
      <div style={{
        ...
        {!collapsed && (
          <button onClick={() => setCollapsed(true)} style={{
            ...
            color: GREY4, padding: 4, flexShrink: 0,
            display: "flex", alignItems: "center",
          }}>
                    ...
                    >
                      ...
                      {!collapsed && (
                        <>
                          ...
                          <ChevronRight size={14} color={GREY4} style={{
                          ...
                          return (
                            ...
                            >
                              ...
                              <span style={{
                                ...
                                color: childActive ? WHITE : GREY4, whiteSpace: "nowrap",
                              }}>{child.label}</span>
                            </Link>
                          );
                        })}
                ...
                >
                  ...
                  {!collapsed && (
                    <span style={{
                      ...
                      color: active ? P : DARK, whiteSpace: "nowrap",
                    }}>{item.label}</span>
                  )}
                </Link>
              );
          ...
          <header style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              {collapsed && (
                ...
                ><Menu size={20} color={GREY4} /></button>
              )}
                ...
                {notifOpen && (
                  <div style={{
                    ...
                    <div style={{
                      ...
                      {unread > 0 && (
                        <span style={{
                          background: P, color: WHITE, fontSize: 10, fontWeight: 700,
